...
def train():
    ...
    for batch_num in range(0, 11):

        train_dataset = ProxDataset_txt(train_data_dir, batch_num=batch_num, max_frame=max_frame, fix_orientation=fix_ori,
        ...
        batch_train_loss /= n_steps  
        total_train_loss += batch_train_loss  
        print(f'Batch {batch_num} Train Loss: {batch_train_loss}')
        logging.info(f'Batch {batch_num} Train Loss: {batch_train_loss}')
    ...
    logging.info(f'====> Epoch {e} Total Train Loss: {total_train_loss}')
...
def validate():
    ...
    with torch.no_grad():
        ...
        logging.info(f'====> ====> Validation Results - Recon Loss: {total_recon_loss_semantics}, CFD: {total_cfd}, Accuracy: {total_acc}')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_data_dir", type=str, default="data/protext/proxd_train/context_versions",
    ...
    parser.add_argument("--save_interval", type=int, default=10, help="Epoch interval for saving model checkpoints.")
