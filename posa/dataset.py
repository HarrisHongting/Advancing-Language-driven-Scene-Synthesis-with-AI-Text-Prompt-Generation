...
class ProxDataset_txt(Dataset):    # when jump_step=8, for a whole seq, dataset's max_frame is 165, max num_seg is 29
    def __init__(self, data_dir, batch_num =1, fix_orientation=False, no_obj_classes=8, max_frame=220,
        ...
        self.context_dir = os.path.join(data_dir, f"context_versions")
        ...
        # for batch in range(1, 11):  # Loop through batches 1 to 10
        #     dataset = ProxDataset_txt(data_dir='path/to/data', batch_num=batch)
